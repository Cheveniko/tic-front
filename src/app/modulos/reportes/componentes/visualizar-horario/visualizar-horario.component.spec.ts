...
describe("VisualizarHorarioComponent", () => {
  ...
  beforeEach(async () => {
    const horarioServiceSpy = jasmine.createSpyObj("HorarioApiService", [
      "obtenerHorarioSemestre",
    ]);
    ...
    mockHorarioService = TestBed.inject(
      HorarioApiService,
    ) as jasmine.SpyObj<HorarioApiService>;
  ...
  describe("Inicialización del componente", () => {
    ...
    it("should have correct hours and days arrays", () => {
      ...
      expect(component.diasSemana).toEqual([
        "Lunes",
        "Martes",
        "Miércoles",
        "Jueves",
  ...
  describe("Carga de datos", () => {
    it("should load horarios successfully", () => {
      mockHorarioService.obtenerHorarioSemestre.and.returnValue(
        of(mockHorarios),
      );
      ...
      expect(mockHorarioService.obtenerHorarioSemestre).toHaveBeenCalledWith(
        "2025-A",
      );
